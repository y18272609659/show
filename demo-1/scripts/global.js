...
function moveElement (elementID,finalX,finalY,interval) {
    ...
    var allME = "moveElement('" + elementID + "'," + finalX + "," + finalY + "," + interval + ")" ;
    elem.movement = setTimeout(allME,interval);
}
...
function validateForm(whichform) {
    for(var i=0 ; i<whichform.element.length ; i++) {
        var element = ehichform.element[i];
...
function submitFormWithAjax( whichform, thetarget ) {
    ...
    // Display a loading message.The message is a picture.
